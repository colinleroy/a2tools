...
_gQuant1_l =      _raw_image+((BAND_HEIGHT-8)*512)+DECODE_WIDTH   ; 64 bytes
_gQuant1_h =      _raw_image+((BAND_HEIGHT-7)*512)+DECODE_WIDTH   ; 64 bytes

.assert .sizeof(hufftable_t) = 64, error
_gHuffTab0 =      _raw_image+((BAND_HEIGHT-6)*512)+DECODE_WIDTH   ; 64 bytes
_gHuffTab1 =      _raw_image+((BAND_HEIGHT-5)*512)+DECODE_WIDTH   ; 64 bytes
_gHuffTab2 =      _raw_image+((BAND_HEIGHT-4)*512)+DECODE_WIDTH   ; 64 bytes
_gHuffTab3 =      _raw_image+((BAND_HEIGHT-3)*512)+DECODE_WIDTH   ; 64 bytes
_gHuffVal0 =      _raw_image+((BAND_HEIGHT-2)*512)+DECODE_WIDTH   ; 16 bytes
