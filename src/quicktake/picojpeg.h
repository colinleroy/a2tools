...
enum
{
   ...
   PJPG_BAD_DHT_COUNTS = 2,
   PJPG_BAD_DHT_INDEX  = 3,
   PJPG_BAD_DHT_MARKER = 4,
   PJPG_BAD_DQT_MARKER = 5,
   PJPG_BAD_DQT_TABLE  = 6,
   PJPG_BAD_PRECISION  = 7,
   PJPG_BAD_HEIGHT     = 10,
   PJPG_BAD_WIDTH      = 11,
   PJPG_TOO_MANY_COMPONENTS = 12,
   PJPG_BAD_SOF_LENGTH = 13,
   PJPG_BAD_VARIABLE_MARKER = 14,
   PJPG_BAD_DRI_LENGTH,
   PJPG_BAD_SOS_LENGTH,
