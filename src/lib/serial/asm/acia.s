...
;
        ...
        .export         _acia_put, _acia_read_byte_sync

.ifdef SERIAL_ENABLE_IRQ
        .export         _acia_irq, _acia_set_irq
.endif
...
BaudOK: sta     tmp1
        ...
        clc
        adc     Index
        sta     acia_put_status_reg+1
        sta     acia_read_status_reg+1
        sta     _ser_status_reg
        lda     #>ACIA_STATUS
        adc     #$00
        sta     acia_put_status_reg+2
        sta     acia_read_status_reg+2
        sta     _ser_status_reg+1

        lda     #<ACIA_DATA
        clc
        adc     Index
        sta     acia_put_data_reg+1
        sta     acia_read_data_reg+1
        sta     _ser_data_reg
        lda     #>ACIA_DATA
        adc     #$00
        sta     acia_put_data_reg+2
        sta     acia_read_data_reg+2
        sta     _ser_data_reg+1
...
_acia_read_byte_sync:
        sec
acia_read_status_reg:
        lda     $FFFF
        and     #$08
        beq     :+
