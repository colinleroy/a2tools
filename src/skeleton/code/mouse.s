...
SMALL_INI_X         = MID_X/4
SMALL_INI_Y         = MID_Y/4
SMALL_PLAYBOX_MIN_X = 0/4
SMALL_PLAYBOX_MAX_X = 255/4
SMALL_PLAYBOX_MIN_Y = 0/4
SMALL_PLAYBOX_MAX_Y = HGR_HEIGHT/4

NORMAL_INI_X        = MID_X/2
NORMAL_INI_Y        = MID_Y/2
NORMAL_PLAYBOX_MIN_X = 0/2
NORMAL_PLAYBOX_MAX_X = 255/2
NORMAL_PLAYBOX_MIN_Y = 0/2
NORMAL_PLAYBOX_MAX_Y = HGR_HEIGHT/2
normal_playbox:
