...
public:
	...
	Imagewriter (Bit16u dpi, Bit16u paperSize, Bit16u bannerSize, char* output, bool multipageOutput, int charset);
	virtual ~Imagewriter();
...
void imagewriter_init(int pdpi, int ppaper, int banner, char* poutput, bool mpage, int charset);
